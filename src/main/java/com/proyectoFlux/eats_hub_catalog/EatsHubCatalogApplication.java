...
public class EatsHubCatalogApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Mono<RestaurantResponse> restaurantResponseMono=restaurantMapper.toResponseMono(
				Mono.just(restaurant)

		);
		Mono<ReservationResponse> reservationResponseMono=reservationMapper.toResponseMono(
				Mono.just(reservation)

		);
		restaurantResponseMono.subscribe(System.out::println);
		reservationResponseMono.subscribe(System.out::println);
